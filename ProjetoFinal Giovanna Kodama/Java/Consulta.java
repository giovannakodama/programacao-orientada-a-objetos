...
public class Consulta extends JFrame implements ActionListener {
  ...
  public Consulta(StorageArte bd) {
    this.bd = bd;
    ...
    buscaLabel = new JLabel("Informe o ID da Fotografia: ");
    ...
    especifico2 = new JLabel("ID fotografia: ");
