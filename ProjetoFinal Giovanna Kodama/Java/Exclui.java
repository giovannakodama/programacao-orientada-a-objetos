...
public class Exclui extends JFrame implements ActionListener {
    ...
    public Exclui(StorageArte bd) {
        ...
        buscaLabel = new JLabel("ID da Fotografia: ");
        ...
        especifico2 = new JLabel("ID da fotografia: ");
      ...
      public void frame() {
        ...
        add(exclui, BorderLayout.AFTER_LAST_LINE);
      ...
      public void actionPerformed(ActionEvent evt) {
        if(evt.getSource().equals(post)) {
          ...
          dsgNome.setText("Designer: ");
          especifico1.setText("Nome da arte: ");
          especifico2.setText("ID Post: ");
          busca.setText("");
          resultValor.setText("--");
        ...
        if(evt.getSource().equals(fotografia)) {
            ...
            dsgCod.setText("ID Designer: ");
            dsgNome.setText("Designer: ");
            especifico1.setText("Local Fotografia: ");
            especifico2.setText("ID Fotografia: ");
            busca.setText("");
            resultValor.setText("--");
            resultLargura.setText("--");
            resultAno.setText("--");
        ...
        if(evt.getSource().equals(confirmar)) {
            if(fotografia.isSelected()) {
              ...
              if(fotografiaDados != null) {
                ...
                JOptionPane.showMessageDialog(null, "ID invaido");
                busca.setText("");
                return;
              }
          ...
          if(evt.getSource().equals(exclui)) {
            if(fotografia.isSelected()) {
              ...
              if(bd.excluiArte(newFotografia)) {
                ...
                JOptionPane.showMessageDialog(null, "Acao incompleta");
                return;
              }
            } else if(post.isSelected()) {
              Post newPost = new Post();
              newPost.setCodPost(Integer.parseInt(busca.getText()));
              if(bd.excluiArte(newPost)) {
                JOptionPane.showMessageDialog(null, "Dados excluidos");
                busca.setText("");
                resultValor.setText("--");
                resultLargura.setText("--");
